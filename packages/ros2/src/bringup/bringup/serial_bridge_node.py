...
from msgs.msg import SerialFrame
...
class SerialBridgeNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("in_topic", "/from_serial")
        self.declare_parameter("out_topic", "/to_serial")
        ...
        self._pub = self.create_publisher(SerialFrame, out_topic, frequency)
