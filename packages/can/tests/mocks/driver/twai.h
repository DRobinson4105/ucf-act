...
// Status info mock (for can_twai_recover polling)
...
static inline esp_err_t twai_driver_install(void *g, void *t, void *f)
{
	(void)g;
	(void)t;
	(void)f;
...
static inline esp_err_t twai_driver_uninstall(void)
{
	return ESP_OK;
}
...
static inline esp_err_t twai_stop(void)
{
	return ESP_OK;
}
static inline esp_err_t twai_transmit(void *msg, uint32_t timeout)
{
	(void)msg;
	(void)timeout;
	return ESP_OK;
}
static inline esp_err_t twai_receive(void *msg, uint32_t timeout)
{
	(void)msg;
	(void)timeout;
	return ESP_ERR_TIMEOUT;
}
static inline esp_err_t twai_initiate_recovery(void)
{
	return ESP_OK;
}
