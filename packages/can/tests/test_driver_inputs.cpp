...
void test_adc_12bitsar_raw_conversion_without_calibration(void)
{
	mock_reset_all();
...
void test_adc_12bitsar_uses_calibration_when_available(void)
{
	mock_reset_all();
...
void test_adc_12bitsar_init_fails_when_adc_setup_fails(void)
{
	mock_reset_all();
...
void test_fr_raw_mapping_matches_pc817_wiring(void)
{
	mock_reset_all();
	set_fr_forward();
...
void test_fr_debounce_requires_stable_interval(void)
{
	mock_reset_all();
	set_fr_forward();
...
void test_fr_init_fails_when_gpio_setup_fails(void)
{
	mock_reset_all();
...
void test_adc_raw_zero_returns_zero_mv(void)
{
	mock_reset_all();
...
void test_adc_raw_4095_returns_3300_mv(void)
{
	mock_reset_all();
	mock_adc_cali_create_result = ESP_FAIL; // use fallback formula
...
void test_adc_read_rejects_out_of_range_raw(void)
{
	mock_reset_all();
	mock_adc_cali_create_result = ESP_FAIL;
...
void test_adc_calibrated_voltage_clamps_to_zero(void)
{
	mock_reset_all();
	mock_adc_cali_create_result = ESP_OK;
...
void test_adc_calibrated_voltage_clamps_to_3300(void)
{
	mock_reset_all();
	mock_adc_cali_create_result = ESP_OK;
	mock_adc_read_raw_value = 100;
...
void test_fr_debounce_resets_on_bounce_back(void)
{
	mock_reset_all();
	set_fr_forward();
...
void test_fr_debounce_resets_on_different_state(void)
{
	mock_reset_all();
	set_fr_forward();
