...
// ----------------------------------------------------------------------------
// CAN ID Encoding (Extended 29-bit CAN 2.0B)
// ----------------------------------------------------------------------------
...
#define UIM2852_PRODUCER_ID_HOST    4   // Master controller ID

// Calculate 29-bit CAN ID for sending instruction to motor
static inline uint32_t uim2852_make_can_id(uint8_t consumer_id, uint8_t cw) {
...
static inline bool uim2852_parse_can_id(uint32_t can_id, uint8_t *producer_id, uint8_t *cw) {
...
#define UIM2852_CW_ACK_BIT          0x80    // OR with CW to request ACK

// Parameter instructions
#define UIM2852_CW_PP               0x01    // System parameters (Node ID, Group ID, etc.)
#define UIM2852_CW_IC               0x0C    // Internal configuration
#define UIM2852_CW_IE               0x0D    // Information enable
#define UIM2852_CW_ER               0x0F    // Error query/report

// Motion status
#define UIM2852_CW_MS               0x11    // Motion status query

// Motion control
#define UIM2852_CW_MO               0x15    // Motor driver on/off
#define UIM2852_CW_BG               0x16    // Begin motion
#define UIM2852_CW_ST               0x17    // Stop motion (decel)
#define UIM2852_CW_SD               0x18    // Stop deceleration rate
#define UIM2852_CW_AC               0x19    // Acceleration
#define UIM2852_CW_DC               0x1A    // Deceleration
#define UIM2852_CW_OG               0x1C    // Set origin
#define UIM2852_CW_JV               0x1D    // Jog velocity
#define UIM2852_CW_SP               0x1E    // Speed for PTP mode
#define UIM2852_CW_PR               0x1F    // Relative position
#define UIM2852_CW_PA               0x20    // Absolute position

// Limits
#define UIM2852_CW_LM               0x21    // Software limits

// Stall/encoder
#define UIM2852_CW_QE               0x22    // Encoder/stall parameters

// Input logic
#define UIM2852_CW_IL               0x23    // Input logic action
#define UIM2852_CW_TG               0x24    // Trigger type/filter

// Brake control
#define UIM2852_CW_MT               0x25    // Brake control

// PVT/PT motion
#define UIM2852_CW_MP               0x26    // PVT motion parameters
#define UIM2852_CW_QP               0x27    // PVT position
#define UIM2852_CW_QV               0x28    // PVT velocity
#define UIM2852_CW_QT               0x29    // PVT time
#define UIM2852_CW_QF               0x2A    // PVT quick feed
#define UIM2852_CW_PV               0x2B    // Select PVT mode
#define UIM2852_CW_PT               0x2C    // PT position

// Real-time notification (from motor)
#define UIM2852_CW_NOTIFY           0x5A    // Real-time notification

// High-speed functions
#define UIM2852_CW_D1               0xD1    // High-speed reciprocating / fixed-angle pulse
...
#define UIM2852_PP_MICROSTEP        5       // Microstepping resolution
#define UIM2852_PP_NODE_ID          7       // Node ID
#define UIM2852_PP_GROUP_ID         8       // Group ID

// IC[i] - Internal configuration
#define UIM2852_IC_DIR_POLARITY     1       // Position counter direction
#define UIM2852_IC_CLOSED_LOOP      6       // Closed loop enable
#define UIM2852_IC_BRAKE_LOGIC      8       // Brake control logic enable
#define UIM2852_IC_STALL_FREEWHEEL  16      // Freewheel on stall (vs lock)

// IE[i] - Information enable (real-time notifications)
#define UIM2852_IE_INPUT1           0       // Input 1 edge notification
#define UIM2852_IE_INPUT2           1       // Input 2 edge notification
#define UIM2852_IE_INPUT3           2       // Input 3 edge notification

// MS[i] - Motion status query
#define UIM2852_MS_FLAGS_RELPOS     0       // Status flags + relative position
#define UIM2852_MS_SPEED_ABSPOS     1       // Speed + absolute position

// LM[i] - Software limits
#define UIM2852_LM_MAX_SPEED        0       // Maximum working speed
#define UIM2852_LM_LOWER_WORK       1       // Lower working limit
#define UIM2852_LM_UPPER_WORK       2       // Upper working limit
#define UIM2852_LM_LOWER_BUMP       3       // Lower bumping limit
#define UIM2852_LM_UPPER_BUMP       4       // Upper bumping limit
#define UIM2852_LM_MAX_POS_ERR      6       // Maximum position error (stall)
#define UIM2852_LM_MAX_ACCEL        7       // Maximum acceleration
#define UIM2852_LM_RESET            254     // Reset limits to defaults
#define UIM2852_LM_ENABLE           255     // Enable/disable limits

// QE[i] - Encoder/stall parameters
#define UIM2852_QE_STALL_TOLERANCE  1       // Stall tolerance in pulses

// MT[i] - Brake control
#define UIM2852_MT_BRAKE            5       // 0=release, 1=engage
...
typedef enum {
    ...
    UIM2852_ALARM_ESTOP_LOCK        = 0x0A,
    UIM2852_ALARM_ACCEL_OVERLIMIT   = 0x16,
    UIM2852_ALARM_SPEED_OVERLIMIT   = 0x17,
    UIM2852_ALARM_LOWER_BUMP        = 0x18,
    UIM2852_ALARM_UPPER_BUMP        = 0x19,
    UIM2852_ALARM_LOWER_WORK        = 0x1A,
    UIM2852_ALARM_UPPER_WORK        = 0x1B,
    UIM2852_ALARM_STALL             = 0x1D,
    UIM2852_ALARM_ENCODER_ERROR     = 0x1E,
    UIM2852_ALARM_ENCODER_BATTERY   = 0x1F,
    
    // Status notifications (d0=type, d1=0)
    UIM2852_STATUS_IN1_FALL         = 0x01,
    UIM2852_STATUS_IN1_RISE         = 0x02,
    UIM2852_STATUS_IN2_FALL         = 0x03,
    UIM2852_STATUS_IN2_RISE         = 0x04,
    UIM2852_STATUS_IN3_FALL         = 0x05,
    UIM2852_STATUS_IN3_RISE         = 0x06,
    UIM2852_STATUS_PTP_COMPLETE     = 0x29,
} uim2852_notification_type_t;
...
typedef enum {
    UIM2852_ERR_SYNTAX              = 0x32, // Instruction syntax error
    UIM2852_ERR_DATA                = 0x33, // Instruction data error
    UIM2852_ERR_SUBINDEX            = 0x34, // Instruction sub-index error
    UIM2852_ERR_SD_LESS_DC          = 0x3C, // SD value < DC value
    UIM2852_ERR_NOT_WHILE_RUNNING   = 0x3D, // Instruction not allowed while running
    UIM2852_ERR_BG_DRIVER_OFF       = 0x3E, // BG not allowed when driver OFF
    UIM2852_ERR_BG_ESTOP            = 0x3F, // BG not allowed during e-stop
    UIM2852_ERR_OG_WHILE_RUNNING    = 0x41, // OG not allowed while running
} uim2852_error_code_t;
...
static inline uint8_t uim2852_cw_with_ack(uint8_t cw) {
    return cw | UIM2852_CW_ACK_BIT;
}

// Check if CW indicates ACK was requested
static inline bool uim2852_cw_ack_requested(uint8_t cw) {
    return (cw & UIM2852_CW_ACK_BIT) != 0;
}

// Get base CW without ACK bit
static inline uint8_t uim2852_cw_base(uint8_t cw) {
    return cw & ~UIM2852_CW_ACK_BIT;
}
