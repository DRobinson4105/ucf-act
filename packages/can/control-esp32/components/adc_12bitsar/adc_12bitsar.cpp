...
[[maybe_unused]] const char *TAG = "ADC_12BITSAR";
...
esp_err_t adc_12bitsar_read_mv_checked(uint16_t *out_mv)
{
	...
	if (voltage_mv < ADC_MV_MIN)
		voltage_mv = ADC_MV_MIN;
	if (voltage_mv > ADC_MV_MAX)
		voltage_mv = ADC_MV_MAX;
