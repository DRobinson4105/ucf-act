...
// Sentinel value for motor dedup trackers — forces next command to send.
// Both steering and braking trackers use int32_t so full actuator travel is preserved.
#define MOTOR_DEDUP_RESET_STEERING INT32_MIN
#define MOTOR_DEDUP_RESET_BRAKING  INT32_MIN
...
#define CONTROL_ACTION_COMPLETE_ENABLE  0x0002 // Finish enable (motors on, throttle autonomous)
